...
describe("gstack-global-discover", () => {
  describe("normalizeRemoteUrl", () => {
    ...
    test("SSH and HTTPS for same repo normalize to same URL", () => {
      const ssh = normalizeRemoteUrl("git@github.com:acme/gstack.git");
      const https = normalizeRemoteUrl("https://github.com/acme/gstack.git");
      const httpsNoDotGit = normalizeRemoteUrl("https://github.com/acme/gstack");
